#!/bin/bash
#SBATCH --job-name=vittt_b_2gpu_bs512_60epoch_no_query
#SBATCH --account=aip-fsanja
#SBATCH --output=output/vittt_b_2gpu_bs512_60epoch_no_query/%x_%j.out
#SBATCH --error=output/vittt_b_2gpu_bs512_60epoch_no_query/%x_%j.err
...
echo "Config: cfgs/vittt_b_no_query.yaml"
echo "=============================================="
