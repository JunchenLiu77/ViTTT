#!/bin/bash
#SBATCH --job-name=vittt_b_2gpu_bs512_60epoch_ga
...
echo "Config: cfgs/vittt_b_ga.yaml"
echo "=============================================="
...
srun uv run python -m torch.distributed.launch \
    ...
    main.py \
    --cfg cfgs/vittt_b_ga.yaml \
    --data-path ~/projects/aip-fsanja/shared/datasets/imagenet/ \
    --output output/vittt_b_2gpu_bs512_60epoch_ga \
    --batch-size 256 \
    --epochs 60 \
    --warmup-epochs 4 \
    --wandb-run-name vittt_b_2gpu_bs512_60epoch_ga \
    --amp
